...
class ExamenController extends Controller
{
    ...
    {
        $questions = Examen::where('user_id',  Auth::user()->id)->get();
    ...
    public function updateExam(Request $request)
    {
        ...
        if ($newQuestions->count() !== count($request->ids)) {
            ...
            foreach ($request->ids as $id) {
                ...
                $question = Examen::where('question_id', $id)->first();
    ...
    {
        Examen::where('user_id', Auth::user()->id)->delete();
    }
    /**
...
// $questions = Question::with('reponses')->whereHas('reponses', function ($query) {
//     $query->where('correcte', true);
// })->get();
